...
const REGLAS: ReadonlyArray<{ match: (hash: string) => boolean; titulo: string }> = [
  ...
  { match: (h) => h.startsWith("#/puestos/wtw"), titulo: "Estructura WTW" },
  ...
  { match: (h) => h.startsWith("#/talento/dashboard"), titulo: "Dashboard de Talento" },
  { match: (h) => /^#\/talento\/encuestas\/\d+\/resultados/.test(h), titulo: "Resultados de encuesta" },
  { match: (h) => h.startsWith("#/talento/encuestas"), titulo: "Encuestas RH" },
  { match: (h) => h.startsWith("#/talento/mis-encuestas"), titulo: "Encuestas de RH" },
  { match: (h) => h.startsWith("#/talento/mis-metas"), titulo: "Mis metas" },
  { match: (h) => h.startsWith("#/talento/mi-desempeno"), titulo: "Mi desempeño" },
