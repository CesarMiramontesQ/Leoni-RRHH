...
/**
 * Va anclado al pie del menú, fuera de las secciones, igual que «Empleados» en el
 * sidebar de RH: el directorio es el punto de entrada a la ficha de una persona,
 * no una más de las tareas del día. Lo pinta `footerGestionHtml` (appShell).
 */
export const SUPERVISOR_EQUIPO_ITEM: SupervisorNavItem = {
  id: "empleados",
  key: "empleados",
  href: "#/empleados",
  // Para supervisor/gerente el directorio es solo su gente: se llama «Equipo».
  label: "Equipo",
...
export const SUPERVISOR_NAV_SECTIONS: readonly SupervisorNavSection[] = [
  ...
  },
  {
    ...
    title: "Mis trámites",
    tipo: "plegable",
    iconSvgPaths: `<path d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" stroke-linecap="round" stroke-linejoin="round" />`,
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "mis-aprobaciones-opl",
        key: "mis-aprobaciones-opl",
        href: "#/mis-aprobaciones-opl",
  ...
  },
  {
    ...
    title: "Mi desarrollo",
    tipo: "plegable",
    iconSvgPaths: `<path d="M3 3v18M3 8.25c1.75-1 3.75-1 5.5 0s3.75 1 5.5 0 3.75-1 5.5 0V15c-1.75 1-3.75 1-5.5 0s-3.75-1-5.5 0-3.75 1-5.5 0V8.25Z" stroke-linecap="round" stroke-linejoin="round" />`,
    items: [
      {
        id: "mis-metas",
        key: "mis-metas",
