      ...
      <ul role="list" class="flex flex-1 flex-col gap-y-7">
        <li>
          <ul role="list" class="-mx-2 space-y-1">
            <li>
              <a href="#/" class="${dashCls}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true" class="${dashIcon}">
            ...
            <li>
              <a href="#/empleados" class="${empCls}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true" class="${empIcon}">
        ...
        <li>
          ...
          <ul role="list" class="-mx-2 mt-2 space-y-1">
            <li>
              <a href="#" class="${navInactive}">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-border bg-white text-[0.625rem] font-medium text-text-muted group-hover:border-leoni-blue group-hover:text-leoni-blue">A</span>
                <span class="truncate">Auditoría</span>
              </a>
            </li>
            <li>
              <a href="#" class="${navInactive}">
                <span class="flex size-6 shrink-0 items-center justify-center rounded-lg border border-border bg-white text-[0.625rem] font-medium text-text-muted group-hover:border-leoni-blue group-hover:text-leoni-blue">N</span>
        ...
        <li class="mt-auto">
          <a href="#" class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-text-primary hover:bg-surface hover:text-leoni-blue">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true" class="${navIconInactive}">
      ...
      <div class="flex items-center gap-x-4 lg:gap-x-6">
        ...
        <el-dropdown class="relative">
          <button type="button" class="relative flex items-center">
            ...
            <span class="flex size-8 shrink-0 items-center justify-center rounded-full bg-leoni-blue-light text-xs font-semibold text-white outline -outline-offset-1 outline-black/5">US</span>
            <span class="hidden lg:flex lg:items-center">
              <span aria-hidden="true" class="ml-4 text-sm/6 font-semibold text-text-primary">Usuario</span>
...
`;
  ...
  container.querySelector("#app-shell-notifications")?.addEventListener("click", () => undefined);
}
