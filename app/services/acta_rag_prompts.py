...
USER_RECOMENDACION_LEGAL_IA_TEMPLATE = (
    ...
    "No reduzcas la salida a un solo artículo cuando existan varios fragmentos aplicables: "
    "incluye TODOS los artículos/fracciones relevantes que estén sustentados por el RAG. "
    "No sustituyas artículos específicos aplicables por artículos genéricos no relacionados. "
