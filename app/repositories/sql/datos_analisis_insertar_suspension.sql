-- Inserta suspension en dbo.PERMISO (TRESS / datos-analisis) con validaciones.
...
BEGIN TRY
  ...
  SET @Data =
    'Tipo: SUS - Suspensión' + CHAR(13) + CHAR(10) +
  ...
  SET @Mensaje = N'Suspensión registrada en TRESS.';
